...
export const getStyleAdvice = async (query, userProfile = {}) => {
  try {
    ...
    const systemPrompt = `
      You are a luxury streetwear stylist for ReeseBlank, a premium fashion brand. 
      ...
      messages: [
        {
          role: "system",
          content:
            "Generate a cool, short caption for this streetwear outfit. Keep it under 50 words and make it Instagram-worthy.",
        },
        {
          role: "user",
